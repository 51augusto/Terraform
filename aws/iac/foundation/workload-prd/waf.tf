...
#  ActivateBadBotProtectionParam = "yes"
  EndpointType = "ALB"
  AppAccessLogBucket = "s3-internal-prd-use1-accesslogs"
#  ErrorThreshold = "50"
...
#  ActivateBadBotProtectionParam = "yes"
  EndpointType = "ALB"
  AppAccessLogBucket = "s3-internal-prd-sae1-accesslogs"
#  ErrorThreshold = "50"
#  RequestThreshold = "100"
#  WAFBlockPeriod = "240"
#  KeepDataInOriginalS3Location = "No"
