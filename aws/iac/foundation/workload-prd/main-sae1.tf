module "vpc_sae1" {
  ...
  intra_subnets    = ["10.52.20.0/22", "10.52.24.0/22", "10.52.28.0/22"]
  public_subnets   = ["10.52.0.0/22", "10.52.4.0/22", "10.52.8.0/22"]
  database_subnets = ["10.52.40.0/22", "10.52.44.0/22", "10.52.48.0/22"]
...
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_prd_sae1" {
  provider           = aws.sae1
...
resource "aws_route" "workload_prd_sae1_route_intra2internet" {
...
resource "aws_route" "workload_prd_sae1_route_db2internet" {
