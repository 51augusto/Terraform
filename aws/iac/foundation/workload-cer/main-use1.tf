module "vpc_use1" {
  ...
  intra_subnets    = ["10.66.20.0/22", "10.66.24.0/22", "10.66.28.0/22"]
  public_subnets   = ["10.66.0.0/22", "10.66.4.0/22", "10.66.8.0/22"]
  database_subnets = ["10.66.40.0/22", "10.66.44.0/22", "10.66.48.0/22"]
...
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_cer_use1" {
  provider           = aws.use1
...
resource "aws_route" "workload_cer_use1_route_intra2internet" {
...
resource "aws_route" "workload_cer_use1_route_database2internet" {
