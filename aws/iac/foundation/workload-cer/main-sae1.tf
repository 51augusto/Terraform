module "vpc_sae1" {
  ...
  intra_subnets    = ["10.56.20.0/22", "10.56.24.0/22", "10.56.28.0/22"]
  public_subnets   = ["10.56.0.0/22", "10.56.4.0/22", "10.56.8.0/22"]
  database_subnets = ["10.56.40.0/22", "10.56.44.0/22", "10.56.48.0/22"]
...
/*
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_cer_sae1" {
  provider           = aws.sae1
...
resource "aws_route" "workload_cer_sae1_route_intra2internet" {
...
resource "aws_route" "workload_cer_sae1_route_database2internet" {
