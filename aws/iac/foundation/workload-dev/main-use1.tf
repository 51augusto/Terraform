module "vpc_use1" {
  ...
  intra_subnets    = ["10.68.20.0/22", "10.68.24.0/22", "10.68.28.0/22"]
  public_subnets   = ["10.68.0.0/22", "10.68.4.0/22", "10.68.8.0/22"]
  database_subnets = ["10.68.40.0/22", "10.68.44.0/22", "10.68.48.0/22"]
...
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_dev_use1" {
  provider           = aws.use1
...
resource "aws_route" "workload_dev_use1_route_intra2internet" {
...
resource "aws_route" "workload_dev_use1_route_database2internet" {
