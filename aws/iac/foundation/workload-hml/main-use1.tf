module "vpc_use1" {
  ...
  intra_subnets    = ["10.64.20.0/22", "10.64.24.0/22", "10.64.28.0/22"]
  public_subnets   = ["10.64.0.0/22", "10.64.4.0/22", "10.64.8.0/22"]
  database_subnets = ["10.64.40.0/22", "10.64.44.0/22", "10.64.48.0/22"]
...
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_hml_use1" {
  provider           = aws.use1
...
resource "aws_route" "workload_hml_use1_route_intra2internet" {
...
resource "aws_route" "workload_hml_use1_route_database2internet" {
