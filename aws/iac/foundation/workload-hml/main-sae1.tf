module "vpc_sae1" {
  ...
  intra_subnets    = ["10.54.20.0/22", "10.54.24.0/22", "10.54.28.0/22"]
  public_subnets   = ["10.54.0.0/22", "10.54.4.0/22", "10.54.8.0/22"]
  database_subnets = ["10.54.40.0/22", "10.54.44.0/22", "10.54.48.0/22"]
...
resource "aws_ec2_transit_gateway_vpc_attachment" "workload_hml_sae1" {
  provider           = aws.sae1
...
resource "aws_route" "workload_hml_sae1_route_intra2internet" {
...
resource "aws_route" "workload_hml_sae1_route_database2internet" {
