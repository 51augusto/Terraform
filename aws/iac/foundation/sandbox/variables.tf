...
variable "private_certificate_domains" {
  ...
  default     = ["*.anbima.cloud", "dev.anbima.cloud", "*.dev.anbima.cloud", "hml.anbima.cloud", "*.hml.anbima.cloud", "cer.anbima.cloud", "*.cer.anbima.cloud", "sbx.anbima.cloud", "*.sbx.anbima.cloud"]
}

variable "public_certificate_domains" {
  type        = list(any)
  description = "Lista de domínios para certificado privado ACM."
  default     = ["*.anbima.com.br", "dev.anbima.com.br", "*.dev.anbima.com.br", "hml.anbima.com.br", "*.hml.anbima.com.br", "cer.anbima.com.br", "*.cer.anbima.com.br", "sbx.anbima.com.br", "*.sbx.anbima.com.br"]
}